$ ->
  ...
  if $datepicker.length > 0
    ...
    $datepicker.Zebra_DatePicker(
      ...
      'days': I18n.translations["#{language}"].admin_js.day
      'days_abbr': I18n.translations["#{language}"].admin_js.abbr_day_names
      'months': I18n.translations["#{language}"].admin_js.month
    )
