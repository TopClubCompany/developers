window.checkNewUser = (selector) ->
  sub_selector = '#' + selector.slice(5)
  user_pass = $("#{sub_selector}_password")
  user_email = $("#{sub_selector}_email")
  user_phone = $("#{sub_selector}_phone")
  user_first_name = $("#{sub_selector}_first_name")
  user_last_name = $("#{sub_selector}_last_name")
...
FormValidateTwo = (selector) ->
  $("#{selector} #user_phone").mask "+38(999)999-99-99"
  $("#{selector} #reservation_phone").mask "+38(999)999-99-99"
  $("#sign_up_page #{selector}").off 'submit'
  $("#sign_up_page #{selector}").on 'submit', (e) ->
    e.preventDefault() unless window.checkNewUser(selector)
