  ...
  module Controllers
    ...
    module TheSortableTree
      ...
      module DefineVariablesMethod
        public
        def the_define_common_variables(_class)
          collection = _class.underscore #self.class.to_s.underscore.split('_').first # recipes
      ...
      module Rebuild
        ...
        def rebuild
          ...
          variable, collection, klass = self.the_define_common_variables(params[:class])
